...
#define PLAYER_STANDING_COLLISIONS 6
#define PLAYER_DUCKING_COLLISIONS 7
#define FLYING_OBSTACLE_COLLISIONS_FIRST 6
#define FLYING_OBSTACLE_COLLISIONS_SECOND 7
